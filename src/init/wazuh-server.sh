...
AUTHOR="Wazuh Inc."
USE_JSON=false
DAEMONS="wazuh-clusterd wazuh-modulesd wazuh-monitord wazuh-logcollector wazuh-remoted wazuh-syscheckd wazuh-analysisd wazuh-maild wazuh-execd wazuh-dbd wazuh-authd wazuh-agentlessd wazuh-integratord wazuh-db wazuh-csyslogd wazuh-apid"
